...
int main(){
    ...
    std::cout << my_utils_kk4::default_color << "default_color" << std::endl
              ...
              << my_utils_kk4::red << "red" << std::endl
              << my_utils_kk4::green << "green" << std::endl
              << my_utils_kk4::yellow << "yellow" << std::endl
    ...
    std::cout << my_utils_kk4::default_color_b << "default_color_b" << std::endl
              << my_utils_kk4::black_b << "black_b" << std::endl
              << my_utils_kk4::white_b << "white_b" << std::endl
              << my_utils_kk4::red_b << "red_b" << std::endl
              << my_utils_kk4::green_b << "green_b" << std::endl
              << my_utils_kk4::yellow_b << "yellow_b" << std::endl
              << my_utils_kk4::blue_b << "blue_b" << std::endl
              << my_utils_kk4::magenta_b << "magenta_b" << std::endl
              << my_utils_kk4::cyan_b << "cyan_b" << std::endl
              << my_utils_kk4::default_color_b << "default_color_b" << std::endl;
